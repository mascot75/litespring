...
public class BeanDefinitionTest extends AbstractV5Test {
    ...
    public void testAopBean() {
        ...
        //检查名称为tx的Bean定义是否生成
        {
            ...
            Assert.assertEquals(bd.getBeanClassName(), TransactionManager.class.getName());
        }
        ...
        //检查placeOrder是否正确生成
        {
            ...
            Assert.assertEquals(bd.getBeanClass(), AspectJExpressionPointcut.class);
        ...
        //检查AspectJBeforeAdvice
        {
            ...
            Assert.assertEquals(bd.getBeanClass(), AspectJBeforeAdvice.class);
            ...
            //构造函数第一个参数
            {
                ...
                Assert.assertEquals(innerBeanDef.getBeanClass(), MethodLocatingFactory.class);
            ...
            //构造函数第三个参数
            {
                ...
                Assert.assertTrue(innerBeanDef.isSynthetic());
                Assert.assertEquals(innerBeanDef.getBeanClass(), AspectInstanceFactory.class);
